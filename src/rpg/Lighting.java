...
public class Lighting {
	...
	public Lighting(Framework fw, int circleSize) {
		...
		darknessFilter = new BufferedImage(2000, 1124, BufferedImage.TYPE_INT_ARGB);
		...
		color[0] = new Color(0,0,0,0.94f);
		color[1] = new Color(0,0,0,0.93f);
		color[2] = new Color(0,0,0,0.90f);
		color[3] = new Color(0,0,0,0.85f);
		color[4] = new Color(0,0,0,0.82f);
		color[5] = new Color(0,0,0,0.82f);
		color[6] = new Color(0,0,0,0.83f);
